...
Opening a pull request will trigger a[workflow](../.github/workflows/agentops_dev-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-2350455894922354.14.azuredatabricks.net/explore/data/models/staging/agentops_dev/agentops_dev-model)
* [Prod model in UC](https://adb-2350455894922354.14.azuredatabricks.net/explore/data/models/prod/agentops_dev/agentops_dev-model)
. 
